/*
    Intention Repeater Image Writer v1.1
    Created 3/27/2022 by Anthro Teacher (AnthroHeart) aka Thomas Sweet.
*/
...
int main()
{
    ...
    cout << "Intention Repeater Image Writer 4K v1.1" << endl;
    ...
    } while (BinaryString.length() < WIDTH * HEIGHT);
